...
class TrainerSpec(base_component.ComponentSpec):
  ...
  PARAMETERS = {
      ...
      'train_fn': ExecutionParameter(type=(str, Text), optional=True),
  ...
  def __init__(
    ...
    Args:
      ...
      module_file: A path to python module file containing UDF model definition.
        Exactly one of 'module_file' or 'train_fn' must be supplied.
      train_fn:  A python path to UDF model definition function. Exactly one of
        'module_file' or 'train_fn' must be supplied.
