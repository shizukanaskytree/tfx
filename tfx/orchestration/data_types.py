...
class DriverArgs(object):
  ...
  Attributes:
    ...
    interactive_artifact_resolution: whether to skip MLMD channel artifact
      resolution, if artifacts are already resolved for a channel when running
      in interactive mode.
  """

  def __init__(self,
               enable_cache: bool = True,
               interactive_artifact_resolution: bool = False):
    self.enable_cache = enable_cache
    self.interactive_artifact_resolution = interactive_artifact_resolution
